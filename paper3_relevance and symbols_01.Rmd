...
*Recent experimental studies have demonstrated that government public communications can enhance citizens' trust in government organizations and their policies not only by conveying substantive information, but also by incorporating strategically designed symbolic element that evoke positive feelings and associations. Yet, under what conditions are citizens more/less likely to be persuaded by symbols? Building on the social psychology Elaboration Likelihood Model (ELM), I theorize that citizens are less susceptible to symbols and more likely to scrutinize the substantive content of the communication, the more they perceive the policy issue in the communication as personally relevant. I test this theory through a survey experiment, where I examine Israeli citizens' trust in the Environment Protection Ministry's policy plans for reducing air pollution in a highly polluted geographical area. The perceived personal relevance of the policy is operationalized both experimentally, and by comparing between citizens residing in the polluted area and elsewhere. Counter to the well-grounded theoretical expectations hypotheses, these comparisons suggest that higher perceived personal relevance does not attentuate the effect of symbols. The theoretical and norative implications of these findings are discussed.*
...
[^footnote_filters]: I filtered out `r N_0-N_1` observations (`r round(((N_0-N_1)/N_0)*100,1)`%) due to multiple entries from the same IP address (n=`r filter_IP`), failure at the instructional manipulation test (n=`r filter_IMC`), submitting the survey in less than 3 or more than 30 minutes (n=`r filter_time`), and respondents under the age of 18 (n=`r filter_age`). These filters are niether associated with the areas nor with the experimental conditions. 
