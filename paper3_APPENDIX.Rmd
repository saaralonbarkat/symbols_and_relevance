...
Moreover, Participants in the relevance treatment group were asked to describe the most salient environmental issue in their particular area of residence. Indeed, most of the Haifa-Bay subjects regarded in their responses to the air-pollution generated from the industrial area, and many of them linked it to higher morbidity rates in the area. Subjects from center cities regarded to a variety of issues, including recycling, traffic jams and cleanliness, whereas relatively few of them mentioned air-pollution as a prominent environmental concern in their area.   
...
**Table A5: Regression table - effect of personal relevance on reaction time**
...
**Table A6: Regression table - effect of personal relevance on memory score**
...
**Table A7: Regression table - effect of personal relevance on within-subject delta between strong and weak policies**
...
**Table A8: Regression table - adding control variables**
...
**Table A9: Regression table - adding personal relevance and motivational control variables**
...
**Table A10: Regression table - unfiltered sample**
